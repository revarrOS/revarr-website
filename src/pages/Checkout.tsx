...
import { CreditCard, Building2, Mail, User, Lock, Check } from 'lucide-react'
            ...
            <div className="space-y-4">
              <div className="bg-gradient-to-br from-blue-950/60 to-blue-900/40 border border-blue-500/40 rounded-lg p-6">
                <h3 className="text-xl font-bold text-white mb-2">
                  {planName === 'PACK 1' ? 'Opportunity Intelligence Engine' : planName}
                </h3>
                <p className="text-4xl font-bold text-blue-400 mb-4">{price}</p>
                <p className="text-sm text-slate-300">
                  {planName === 'PACK 1' ? 'One-Time Payment' : 'Billed monthly'}
                </p>
              </div>
                  ...
                  {planName === 'PACK 1' ? (
                    <>
                      <div className="flex items-start gap-2">
                        ...
                        <div>
                          <div className="font-semibold text-white">Market Position Snapshot</div>
                          <div className="text-xs text-slate-400">Instantly see where your product fits and which segments are growing.</div>
                        </div>
                      </div>
                      <div className="flex items-start gap-2">
                        <Check size={18} className="flex-shrink-0 mt-0.5 text-emerald-400" />
                        <div>
                          <div className="font-semibold text-white">Competitor Strength Ranking</div>
                          <div className="text-xs text-slate-400">Ranks your top competitors so you know who is strong, who is weak, and why.</div>
                        </div>
                      </div>
                      <div className="flex items-start gap-2">
                        <Check size={18} className="flex-shrink-0 mt-0.5 text-emerald-400" />
                        <div>
                          <div className="font-semibold text-white">Revenue Forecasting</div>
                          <div className="text-xs text-slate-400">See what winning 50, 100, or 200 customers really means over 5 years.</div>
                        </div>
                      </div>
                      <div className="flex items-start gap-2">
                        <Check size={18} className="flex-shrink-0 mt-0.5 text-emerald-400" />
                        <div>
                          <div className="font-semibold text-white">White-Space Finder</div>
                          <div className="text-xs text-slate-400">Uncovers gaps your competitors have not touched yet.</div>
                        </div>
                      </div>
                      <div className="flex items-start gap-2">
                        <Check size={18} className="flex-shrink-0 mt-0.5 text-emerald-400" />
                        <div>
                          <div className="font-semibold text-white">Best Industries to Target</div>
                          <div className="text-xs text-slate-400">A clear ranking of industries with the fastest path to revenue.</div>
                        </div>
                      </div>
                      <div className="flex items-start gap-2">
                        <Check size={18} className="flex-shrink-0 mt-0.5 text-emerald-400" />
                        <div>
                          <div className="font-semibold text-white">Best Regions to Target</div>
                          <div className="text-xs text-slate-400">NA, EMEA, APAC, LATAM ranked by opportunity and ease of entry.</div>
                        </div>
                      </div>
                      <div className="flex items-start gap-2">
                        <Check size={18} className="flex-shrink-0 mt-0.5 text-emerald-400" />
                        <div>
                          <div className="font-semibold text-white">Market Risk Alerts</div>
                          <div className="text-xs text-slate-400">Warnings for slow, saturated, or declining markets you should avoid.</div>
                        </div>
                      </div>
                      <div className="flex items-start gap-2">
                        <Check size={18} className="flex-shrink-0 mt-0.5 text-emerald-400" />
                        <div>
                          <div className="font-semibold text-white">Your 90-Day Action Plan</div>
                          <div className="text-xs text-slate-400">A simple, personal roadmap showing what to do first, second, and third.</div>
                        </div>
                      </div>
                    </>
                  ) : (
              ...
              <div className="border-t border-slate-700 pt-4">
                ...
                <p className="text-xs text-slate-400">
                  {planName === 'PACK 1'
                    ? 'This is a one-time payment and no further payment will be taken.'
