...
export default function AIEngineLadder() {
  ...
  const engines = [
    ...
    },
    {
      ...
      aiOnly: false,
      outcomes: [
        'Pipeline opportunity detection & mapping',
        ...
        'Partner influence tracking & attribution',
      ],
    },
    {
      level: 6,
      label: 'Deal Routing Engine',
      color: 'from-blue-400/85 to-blue-300/85',
      border: 'border-blue-200/85',
      aiOnly: false,
      outcomes: [
        'Automatic deal registration & approval routing',
        'Co-sell workflow automation',
        'Zero-login partner experience',
        'Meeting assistant & scheduling automation',
        'Deal momentum tracking & risk alerts',
      ],
    },
    {
      level: 7,
      label: 'Channel Analytics',
      color: 'from-blue-300/90 to-blue-200/90',
      border: 'border-blue-100/90',
      aiOnly: false,
      outcomes: [
        'Real-time revenue dashboards',
        'Partner performance scoring & analytics',
        'Churn prediction & risk modeling',
        'ROI & efficiency optimization',
        'Automated QBR & executive report generation',
      ],
    },
  ]
