              ...
              <div className="flex items-start gap-6">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-slate-300 text-lg mb-4">
                    The Nervous System: Where intelligence becomes an ENGINE. All 56 features execute here.
                  </p>
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                    {['Opportunity Intelligence', 'Partner Intelligence', 'Partner Acquisition', 'Partner Enablement', 'Partner Revenue Intelligence', 'Channel Growth', '56 Features'].map((item, i) => (
