...
import OpportunityIntelligenceEngine from './pages/OpportunityIntelligenceEngine'
  ...
  return (
    <div className="min-h-screen bg-slate-950">
      ...
      <Routes>
        ...
        <Route path="/product/opportunity-intelligence-engine" element={<OpportunityIntelligenceEngine />} />
